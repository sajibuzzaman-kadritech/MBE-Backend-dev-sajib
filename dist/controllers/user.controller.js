...
class User {
    constructor() {
        ...
        this.addAdminUserDefault = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const dto = null;
                const existingUser = yield this.userDAO.getByEmail("admin@gmail.com");
                if (existingUser) {
                    throw new handled_application_error_1.default(409, 'email id already registered');
                }
                const hashedPassword = yield this.generateHash('multibrandelectronicsmbes', "123456");
                dto.password = hashedPassword;
                const currentTime = (0, moment_1.default)().toISOString();
                dto.created = {
                    // @ts-ignore
