...
const items_schema_2 = require("../../models/items.schema");
...
class AdminItems {
    constructor() {
        this.changeItemStatus = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.addItem = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (deal._id !== null) {
                    ...
                    const updatedDeal = yield this.dealsDAO.update(deal._id, getDealByID);
                }
        ...
        this.addExportItem = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                let list = req.body;
                ...
                // @ts-ignore
                list === null || list === void 0 ? void 0 : list.forEach((element) => {
                    // console.log(element);
                    element.brand = brands.find((brand) => brand.name === element.brand);
                    element.category = categories.find((category) => category.name === element.category);
                    let deal;
                    if (element.deal) {
                ...
                let promise = new Promise(function (resolve, reject) {
                    return __awaiter(this, void 0, void 0, function* () {
                        const result = yield items_schema_1.itemsModel.insertMany(list);
                        if (result) {
                ...
                promise.then(function (result) {
                    // console.log(result);
                    // @ts-ignore
                    result === null || result === void 0 ? void 0 : result.forEach((element) => __awaiter(this, void 0, void 0, function* () {
                        if (element.deal !== 'none') {
                            const getDeal = deals.find((deal) => deal.name === element.deal);
                            getDeal.items.push(element);
                            yield deals_schema_1.dealsModel.findByIdAndUpdate(getDeal._id, getDeal);
                        }
                    }));
                });
                res.json({ success: true, status: 'success' });
        ...
        this.updateItems = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const id = req.params.id;
                    ...
                    if (deal._id != null || deal._id != undefined) {
                        ...
                        if (!(getDealByID.items.length > 0)) {
                            ...
                            if (getDealByProductId.length > 0) {
                                let filteredItems = getDealByProductId[0].items.filter((obj, index) => {
                                ...
                                let removedProduct = yield this.dealsDAO.update(getDealByProductId[0]._id, cDeal);
                            }
                        ...
                        if (getRelatedDeal.length > 0) {
                            if (getRelatedDeal[0].items.length > 0) {
                                ...
                                const updatedDeal = yield this.dealsDAO.update(getRelatedDeal[0]._id, getRelatedDeal[0]);
                            }
                        }
                    }
                }
        ...
        this.relistItem = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const id = req.params.id;
        ...
        this.getDeletedItems = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.getItemsAdmin = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const countTotal = yield items_schema_2.itemsModel.countDocuments(filter);
