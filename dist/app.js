...
class App {
    ...
    initializeDatabase() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            mongoose_1.default.set('maxTimeMS', config_1.default.get('database.query-max-ms'));
            const dbConnectionString = config_1.default.get('database.platform.connection-string') +
