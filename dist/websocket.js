...
exports.default = (expressServer) => {
    let messageDAO = new message_dao_1.default();
    let userDAO = new user_dao_1.default();
        ...
        socket.on('message', (msg, callback) => {
            ...
            (() => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    const data = yield messageDAO.getByFilter({ $and: [
                    ...
                    if (!data) {
                        if (dto.senderId == '2') {
                            ...
                            const senderDetails = yield userDAO.getById(dto.senderId);
                        ...
                        const result = yield messageDAO.create(pdto);
                        (() => {
                    ...
                    const rest = yield messageDAO.updateC(chatDetails._id.toString(), updateBody);
    ...
    let readPreSignedUrl = (fileName) => __awaiter(void 0, void 0, void 0, function* () {
        try {
