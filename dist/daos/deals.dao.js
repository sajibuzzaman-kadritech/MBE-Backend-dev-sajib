...
class DealsDAO {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return deals_schema_1.dealsModel.findOneAndDelete({ _id: mongoose_1.default.Types.ObjectId(id) });
        });
    }
    statusChange(id, params) {
        return __awaiter(this, void 0, void 0, function* () {
            if (params.status === 'Active') {
                return deals_schema_1.dealsModel.findOneAndUpdate({ _id: mongoose_1.default.Types.ObjectId(id) }, { status: 'Not Active' });
            }
            return deals_schema_1.dealsModel.findOneAndUpdate({ _id: mongoose_1.default.Types.ObjectId(id) }, { status: 'Active' });
        });
    }
}
