...
class ItemsDAO {
    ...
    getDashboardItems(fromdate, todate) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log((0, moment_1.default)(fromdate, 'YYYY-M-DD').format(), (0, moment_1.default)(todate, 'YYYY-M-DD').add('1', 'days').format());
            return yield items_schema_1.itemsModel
                .find({
                'added.at': {
    ...
    changeStatus(id, status) {
        return __awaiter(this, void 0, void 0, function* () {
            if (status === 'active') {
                return items_schema_1.itemsModel.findOneAndUpdate({ _id: mongoose_1.default.Types.ObjectId(id) }, { status: 'not active' });
            }
            return items_schema_1.itemsModel.findOneAndUpdate({ _id: mongoose_1.default.Types.ObjectId(id) }, { status: 'active' });
        });
    }
    deleteItem(id) {
        return __awaiter(this, void 0, void 0, function* () {
