const standardErrorCodes: any = {
  ...
  code_301:
    'Moved Permanently; This and all future requests directed to the given URI',
  ...
  code_501:
    'Not Implemented; Server does not recognize method or lacks ability to fulfill',
